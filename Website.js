...
( function () {
    ...
    function populateWomen(type) {
        ...
        let url = "https://finalprojectrgrimes:process.env.PORT.herokuapp.com/?gen=female&type=" + type;
        console.log("working");
        fetch(url)
            .then(checkStatus)
    ...
    function populateMen(type) {
        let contentArea = document.getElementById("block1-products")
        contentArea.innerHTML = "";
        let url = "https://finalprojectrgrimes:process.env.PORT.herokuapp.com/?gen=men&type=" + type;
        console.log("working");
        fetch(url)
            .then(checkStatus)
            .then(function(responseText) {
